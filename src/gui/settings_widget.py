...
from PyQt6.QtWidgets import (
    ...
    QCheckBox, QFileDialog, QLineEdit, QGroupBox, QFrame, QGridLayout
)
...
class SettingsWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.option_checkboxes["download_images"].setToolTip("Включает скачивание изображений из глав")
        ...
        self.option_checkboxes["add_translator"].setToolTip("Добавляет строку с переводчиком после названия главы")
        ...
        self.option_checkboxes["group_by_volumes"].setToolTip("Группировка по томам вместо указания тома в названии главы")
    ...
    def _load_settings(self):
        ...
        # Загружаем путь сохранения
        self.path_edit.setText(settings.get("save_directory"))
        
        # Загружаем выбранные форматы
    ...
    def _browse_directory(self):
        ...
        if directory:
            # Нормализуем путь и устанавливаем его.
            # Сигнал textChanged автоматически вызовет сохранение.
    ...
    def get_selected_formats(self) -> List[str]:
        ...
        return [format_name for format_name, checkbox in self.format_checkboxes.items() 
